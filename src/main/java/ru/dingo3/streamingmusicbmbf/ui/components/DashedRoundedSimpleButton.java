...
public class DashedRoundedSimpleButton extends JButton {
    ...
    public DashedRoundedSimpleButton(String text, int width, int height, int arcWidth, int arcHeight) {
        super(text);
        this.width = width;
        this.height = height;
...
//    }
    public DashedRoundedSimpleButton(String text) {
